...
public class Resolution_Modifier {
	...
	try{
        ...
        {
		BufferedImage originalImage = ImageIO.read(new File("C:\\Mini_project\\Codes\\Receiving\\Media\\bin\\final_frames\\"+i+".jpg"));
		int type = originalImage.getType() == 0? BufferedImage.TYPE_INT_ARGB : originalImage.getType();

		BufferedImage resizeImageJpg = resizeImage(originalImage, type);
		ImageIO.write(resizeImageJpg, "jpg", new File("C:\\Mini_project\\Codes\\Receiving\\Media\\bin\\resized_final_frames\\"+i+".jpg"));
